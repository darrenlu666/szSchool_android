...
public class BoxingBottomSheetFragment extends AbsBoxingViewFragment implements View.OnClickListener {
    ...
    private LinearLayout mBottomSheetTitle;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mBottomSheetTitle = (LinearLayout) view.findViewById(R.id.ll_boxing_bottom_sheet);
        mBottomSheetTitle.setBackgroundColor(getColorPrimary());
