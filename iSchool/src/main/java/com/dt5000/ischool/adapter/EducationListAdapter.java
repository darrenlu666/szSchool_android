 ...
 * 
 * @author 周锋
 * @date 2016年2月2日 上午11:23:32
 * @ClassInfo com.dt5000.ischool.adapter.EducationListAdapter
 * @Description
 */
public class EducationListAdapter extends BaseAdapter {
	...
	public EducationListAdapter(Context ctx, List<Publication> data) {
		this.context = ctx;
		this.list = data;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.view_list_item_education,
					null);
