...
public class ChildrenListAdapter extends BaseAdapter {
	...
	public ChildrenListAdapter(Context ctx, List<Publication> data) {
		this.context = ctx;
		this.list = data;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.view_list_item_children,
					null);
			viewHolder.txt_name = (TextView) convertView
					.findViewById(R.id.txt_name);
			viewHolder.txt_time = (TextView) convertView
					.findViewById(R.id.txt_time);
			viewHolder.txt_read = (TextView) convertView
					.findViewById(R.id.txt_read);
		...
		viewHolder.txt_read.setText("阅读 " + publication.getVisitorNum());
