 ...
 * 
 * @author 周锋
 * @date 2016年2月19日 上午9:14:25
 * @ClassInfo com.dt5000.ischool.adapter.teacher.BlogClassListAdapter
 * @Description
 */
public class BlogClassListAdapter extends BaseAdapter {

	private Context context;
	private LayoutInflater inflater;
	private List<ClassItem> list;

	public BlogClassListAdapter(Context ctx, List<ClassItem> datas) {
		this.context = ctx;
		this.list = datas;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.view_list_item_blog_class,
					null);
