 ...
 * @Description
 */
public class HomeworkGroupListActivity extends Activity {
	...
	private void initView() {
		...
		// 添加FooterView
		loadMoreFooterView = new LoadMoreFooterView(HomeworkGroupListActivity.this,
	...
	private void initListener() {
		...
		lLayout_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				HomeworkGroupListActivity.this.finish();
			}
		});
		...
		listview_homework
				.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Intent intent = new Intent(HomeworkGroupListActivity.this,
						...
						try {
							...
							if (data != null && data.size() > 0) {
								...
								homeworkListAdapter = new HomeworkListAdapter(
										HomeworkGroupListActivity.this, homeworkList);
								listview_homework
