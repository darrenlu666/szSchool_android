...
import com.dt5000.ischool.adapter.student.ScoreListAdapter;
 ...
 * 
 * @author 周锋
 * @date 2016年1月15日 上午10:16:48
 * @ClassInfo com.dt5000.ischool.activity.student.ScoreListActivity
 * @Description
 */
public class ScoreListActivity extends Activity {
	...
	private void initListener() {
		...
		listview_score.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View view,
				...
				Intent intent = new Intent(ScoreListActivity.this,
						ScorePieActivity.class);
	...
	private void getData() {
		...
		map.put("operationType", UrlProtocol.OPERATION_TYPE_MY_SCORE);
		map.put("pageNo", String.valueOf(PAGE_NO));
		map.put("pageSize", String.valueOf(PAGE_SIZE));
		map.put("gradeId", user.getGradeinfoId());
