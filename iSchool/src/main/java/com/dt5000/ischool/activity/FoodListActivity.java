...
import com.dt5000.ischool.adapter.FoodListAdapter;
 ...
 * 
 * @author 周锋
 * @date 2016年3月3日 上午11:06:37
 * @ClassInfo com.dt5000.ischool.activity.FoodListActivity
 * @Description
 */
public class FoodListActivity extends Activity {
	...
	private void initView() {
		...
		txt_title.setText("每周食谱");
		listview = (ListView) findViewById(R.id.listview);

		// 添加FooterView
		loadMoreFooterView = new LoadMoreFooterView(FoodListActivity.this,
						...
						try {
							...
							if (data != null && data.size() > 0) {
								...
								foodListAdapter = new FoodListAdapter(
										FoodListActivity.this, publicationList);
