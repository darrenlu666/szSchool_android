...
import com.dt5000.ischool.activity.LessonTableActivity;
import com.dt5000.ischool.adapter.teacher.LessonTableClassListAdapter;
 ...
 * 
 * @author 周锋
 * @date 2016年3月4日 上午9:23:19
 * @ClassInfo com.dt5000.ischool.activity.teacher.LessonTableClassListActivity
 * @Description
 */
public class LessonTableClassListActivity extends Activity {
	...
	private LessonTableClassListAdapter lessonTableClassListAdapter;
	private FinalHttp finalHttp;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_lesson_table_class_list);
	...
	private void initListener() {
		...
		lLayout_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				LessonTableClassListActivity.this.finish();
			}
		});
		...
		listview_class.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				Intent intent = new Intent(LessonTableClassListActivity.this,
					...
					public void onSuccess(String t) {
						...
						try {
							...
							if (data != null && data.size() > 0) {
								classList = data;
								lessonTableClassListAdapter = new LessonTableClassListAdapter(
										LessonTableClassListActivity.this,
										classList);
								listview_class
										.setAdapter(lessonTableClassListAdapter);
							}
						} catch (Exception e) {
							e.printStackTrace();
						}
