 ...
 * 
 * @author 周锋
 * @date 2016年2月1日 下午7:16:47
 * @ClassInfo com.dt5000.ischool.activity.DianDianGoActivity
 * @Description
 */
public class DianDianGoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_dian_dian_go);
	...
	private void initListener() {
		...
		lLayout_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				DianDianGoActivity.this.finish();
			}
		});
	...
	private void getData() {
		...
		map.put("operationType", UrlProtocol.OPERATION_TYPE_DIAN_DIAN_GO);
		...
		finalHttp.post(UrlProtocol.MAIN_HOST, ajaxParams,
				new AjaxCallBack<String>() {
					...
					public void onSuccess(String t) {
						MLog.i("获取点点GO网址返回数据：" + t);
						try {
							JSONObject obj = new JSONObject(t);
							web_url = obj.optString("url");
							if (!CheckUtil.stringIsBlank(web_url)) {
