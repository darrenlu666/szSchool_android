 ...
 * @Description
 */
public class PlayVideoActivity2 extends Activity implements OnClickListener,
    ...
    private RelativeLayout lLayout_play_msg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lLayout_play_msg = (RelativeLayout) findViewById(R.id.lLayout_play_msg);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        try {
            ...
            if(isSelf){
                ...
                mediaPlayer.setDataSource(getCacheDir() + "/" + videoName);
                mediaPlayer.prepareAsync();// 4.异步加载
            }else{
                mediaPlayer.setDataSource(videoUrl);// 2.设置播放源
                mediaPlayer.prepareAsync();// 4.异步加载
                ...
                .setPositiveButton("保存",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                                int which) {
                                VideoUtil.downLoadVideo(PlayVideoActivity2.this, videoUrl, videoName);
                                findViewById(R.id.iv_downLoad).setVisibility(View.GONE);
                            }
