 ...
 * @ClassInfo com.dt5000.ischool.activity.teacher.GroupHomeworkListActivity
 * @Description
 */
public class GroupHomeworkListActivity extends Activity {
	...
	private void initView() {
		...
		// 添加FooterView
		loadMoreFooterView = new LoadMoreFooterView(GroupHomeworkListActivity.this,
	...
	private void initListener() {
		...
		lLayout_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				GroupHomeworkListActivity.this.finish();
			}
		});
		...
		listview_homework
				.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Intent intent = new Intent(GroupHomeworkListActivity.this,
								GroupHomeworkDetailActivity.class);
	...
	private void init() {
		groupItem = (GroupItem) getIntent().getExtras().getSerializable(
				"groupItem");

		txt_title.setText(groupItem.getGroupName());

		finalHttp = new FinalHttp();

		homeworkList = new ArrayList<Homework>();

		user = User.getUser(GroupHomeworkListActivity.this);
	}
	...
	private void getData() {
		...
		map.put("operationType", UrlProtocol.OPERATION_TYPE_GROUP_HOMEWORK_LIST);
		map.put("groupid", groupItem.getGroupId());
						...
						try {
							...
							if (data != null && data.size() > 0) {
								...
								homeworkListAdapter = new HomeworkListAdapter(
										GroupHomeworkListActivity.this, homeworkList);
								listview_homework
