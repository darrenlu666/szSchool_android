...
import com.dt5000.ischool.activity.DiaryListActivity;
import com.dt5000.ischool.adapter.teacher.DiaryClassListAdapter;
 ...
 * 
 * @author 周锋
 * @date 2016年2月18日 下午2:46:47
 * @ClassInfo com.dt5000.ischool.activity.teacher.DiaryClassListActivity
 * @Description
 */
public class DiaryClassListActivity extends Activity {
	...
	private DiaryClassListAdapter diaryClassListAdapter;
	private FinalHttp finalHttp;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_diary_class_list);
	...
	private void initListener() {
		...
		lLayout_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				DiaryClassListActivity.this.finish();
			}
		});
		...
		listview_class.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				Intent intent = new Intent(DiaryClassListActivity.this, DiaryListActivity.class);
					...
					public void onSuccess(String t) {
						...
						try {
							...
							if (data != null && data.size() > 0) {
								classList = data;
								diaryClassListAdapter = new DiaryClassListAdapter(
										DiaryClassListActivity.this, classList);
								listview_class
										.setAdapter(diaryClassListAdapter);
							}
						} catch (Exception e) {
							e.printStackTrace();
						}
